                ...
                <div className="relative">
                    ...
                    <div className="flex items-center justify-between py-4 border-y border-slate-100 dark:border-slate-800 gap-2">
                        <div className="text-center flex-1">
                            <p className="text-[9px] font-bold text-slate-400 uppercase tracking-wider mb-0.5">Reputation</p>
                            <p className="text-sm font-bold text-slate-900 dark:text-white">{user?.reputationScore || 0}</p>
                        </div>
                        <div className="w-[1px] h-8 bg-slate-100 dark:bg-slate-850" />
                        <div className="text-center flex-1">
                            <p className="text-[9px] font-bold text-slate-400 uppercase tracking-wider mb-0.5">Echoes</p>
                    ...
                    <Link 
                        to={`/profile/${user?.id}`}
                        className="flex items-center justify-center gap-1.5 w-full mt-6 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl text-[10px] font-bold uppercase tracking-wider hover:scale-[1.01] transition-transform active:scale-95 shadow-sm"
                    >
                        View Identity
                        <Shield size={12} />
                    </Link>
